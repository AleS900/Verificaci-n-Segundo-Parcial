...
public class projectCUDTest extends BaseTodoLy {
    ...
    public String projectName = "Santiago" + dtf.format(LocalDateTime.now());
    public String newProjectName ="Alejandro"+ dtf.format(LocalDateTime.now());
